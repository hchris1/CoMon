...
@Component({
  selector: 'app-retention-setting-tile',
  templateUrl: './retention-setting-tile.component.html',
})
export class RetentionSettingTileComponent extends AppComponentBase {
