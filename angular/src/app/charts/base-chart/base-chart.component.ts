...
import { ApexAxisChartSeries, ApexChart, ApexNonAxisChartSeries, ApexTheme, ApexTitleSubtitle, ApexXAxis, ApexYAxis, ChartComponent, ChartType } from 'ng-apexcharts';
...
export class BaseChartComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    this.isDarkModeSubscription = this._darkModeService.isDarkMode.subscribe((isDarkMode: boolean) => {
