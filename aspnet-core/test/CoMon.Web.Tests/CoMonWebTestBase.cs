...
{
    public abstract class CoMonWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CoMonWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CoMonWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CoMonDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CoMonDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CoMonDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CoMonDbContext, Task<T>> func)
        {
            T result;
